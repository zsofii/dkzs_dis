...
while 1:
	...
	represent=line[1]
	valid[represent]="r"
	represent2=line[2].strip().split(",")
	for i in range (0, len(represent2)):
		valid[represent2[i]]="r"
inf.close()
...
###MAIN
print("REDUNDANT DATASET ALL DATA")
print(";;;;;;;;;;;;DM;PM;Odds ratio")
[cc,DM,PM,cc7,DM7,PM7]=cc_residue("Deepcoil","r",boundary,mutation,valid,seqs)
odds_a=[]
dm_a=[]
pm_a=[]
dm7_a=[]
...
[cc,DM,PM,cc7,DM7,PM7]=cc_residue("Marcoil","r",boundary,mutation,valid,seqs)
mut={"1-7":{"DM":DM7,"PM":PM7},"rest":{"DM":DM,"PM":PM}}
mut2=pd.DataFrame.from_dict(mut)
...
dm7_a.append(DM7/cc7)
pm7_a.append(PM7/cc7)
[cc,DM,PM,cc7,DM7,PM7]=cc_residue("Ncoils","r",boundary,mutation,valid,seqs)
mut={"1-7":{"DM":DM7,"PM":PM7},"rest":{"DM":DM,"PM":PM}}
mut2=pd.DataFrame.from_dict(mut)
...
dm7_a.append(DM7/cc7)
pm7_a.append(PM7/cc7)
[cc,DM,PM,cc7,DM7,PM7]=cc_residue("Paircoil","r",boundary,mutation,valid,seqs)
mut={"1-7":{"DM":DM7,"PM":PM7},"rest":{"DM":DM,"PM":PM}}
mut2=pd.DataFrame.from_dict(mut)
